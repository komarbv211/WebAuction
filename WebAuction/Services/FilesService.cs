...
namespace Core.Services
{
    public class FilesService : IFilesService
    {
        ...
        public Task DeleteLotImage(string path)
        {
        ...
        public async Task<string> EditLotImage(string oldPath, IFormFile newFile)
        {
            await DeleteLotImage(oldPath);
            return await SaveLotImage(newFile);
        }

        public async Task<string> SaveLotImage(IFormFile file)
        {
