...
namespace Data.Data
{
    public class AuctionDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Bid { Id = 1, LotId = 1, Amount = 550, BidTime = DateTime.Now.AddDays(-5), BidderId = 1 },
                new Bid { Id = 2, LotId = 1, Amount = 600, BidTime = DateTime.Now.AddDays(-4), BidderId = 3 },
                new Bid { Id = 3, LotId = 1, Amount = 700, BidTime = DateTime.Now.AddDays(-3), BidderId = 2 },
            });
        }
    }
}
